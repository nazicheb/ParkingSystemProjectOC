...
public class DBConstants {
    ...
    public static final String GET_USER = " select LICENCE_PLATE_NUMBER from user where LICENCE_PLATE_NUMBER=? limit 1";
    public static final String SAVE_USER = "insert into user(LICENCE_PLATE_NUMBER) values(?)";
}
